...
<body>
	...
	<div class="container">
		...
		<div class="container" >
			<form class="form-signin" action="CommodityServlet?method=cash" method="post" style="width:330px;margin:0 auto;">
	        	<h2 class="form-signin-heading">请填写信息完成支付！</h2>
	        	...
	        	<label for="inputPassword" class="sr-only">信用卡/支付宝账号</label>
